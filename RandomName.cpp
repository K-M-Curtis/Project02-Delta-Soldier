...
using namespace std;
#define RANDOM_NAME_FIRST_FILE "/home/deng/projects/GameTest/random_first.txt"
#define RANDOM_NAME_LAST_FILE "/home/deng/projects/GameTest/random_last.txt"
...
void RandomName::LoadFile()
{
	...
	{
		cerr << "Error in open namefile" << endl;
	}
}
